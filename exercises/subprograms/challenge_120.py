...
def check_answer_addition(num_1, num_2, user_answer):
    correct_answer = num_1 + num_2
    return (user_answer == correct_answer, correct_answer)


def check_answer_subtraction(num_1, num_2, user_answer):
    correct_answer = num_1 - num_2
    return (user_answer == correct_answer, correct_answer)
...
def process_addition():
    ...
    return check_answer_addition(num_1, num_2, user_answer)
...
def process_subtraction():
    ...
    print(f"{num_1} - {num_2} =")
    user_answer = ask_for_user_input()
    return check_answer_subtraction(num_1, num_2, user_answer)
...
def challenge_execution():
    ...
    if user_input == 1:
        (is_answer_correct, correct_answer) = process_addition()
    elif user_input == 2:
        (is_answer_correct, correct_answer) = process_subtraction()
    else:
